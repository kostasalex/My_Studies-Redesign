...
export const studentInfoCardData = [
    ...
    },
    {
        ...
        text: 'Εγγραφείτε τώρα στα μαθήματά σας, εύκολα και γρήγορα, με μια απλή φόρμα!'
    },
    {
        id: 3,
...
export const teacherInfoCardData = [
    {
        id: 1,
        title: 'Βαθμολόγηση',
        text: 'Οργανώστε τη διαδικασία βαθμολόγησης χρησιμοποιώντας την εύκολη λειτουργία ανεβάσματος.'
    },
    {
        id: 2,
        title: 'Πρόσβαση σε Παλαιότερους Βαθμούς',
        text: 'Ανακτήστε παλαιότερους βαθμούς με ευκολία. Προσπελάστε γρήγορα την ακαδημαϊκή επίδοση από προηγούμενες περιόδους.',
    },
    {
        id: 3,
